...
router.post('/result', getuser, async (req, res) => {
  try {
    ...
    const finalPrompt = `
    Based on the following question and answer, rate the answer on a scale from 0 to 100, and provide an explainable feedback about the answer to make it better. Do not generate a single letter other than a score in numeric form and feedback in JS and do not use backticks in the output.\n\n
